...
public:
	...
	/* Accessor function for initial power, BlueprintPure means the function isn't modifying the state*/
...
protected:
	...
	/* Multiplier for our character's speed */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", meta = (BlueprintProtected = "true"))
	float SpeedFactor;
	...
	//BlueprintImplementable means that we dont have to define the function in code at all we just let the blueprints handle the code
